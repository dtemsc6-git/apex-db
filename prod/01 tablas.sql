  ...
  ;
   ...
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1082 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
...
ALTER TRIGGER "TRG_AUDIT_SGT_CONEXIONES_SERVICIO" ENABLE;
  ...
  CREATE TABLE "SGT_DEPTO" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 19 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"NOMBRE" VARCHAR2(100) NOT NULL ENABLE, 
...
ALTER TRIGGER "TRG_AUDIT_SGT_DEPTO" ENABLE;
  ...
  CREATE TABLE "SGT_ENLACES_FO" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1193 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"NOMBRE" VARCHAR2(255), 
	"SITIO_ID_A" NUMBER, 
	"EQUIPO_ID_A" NUMBER, 
	"SITIO_ID_B" NUMBER, 
...
ALTER TRIGGER "TRG_AUDIT_SGT_ENLACES_FO" ENABLE;
  ...
  CREATE TABLE "SGT_ENLACES_LOGICOS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"SITIO_A_ID" NUMBER, 
	"EQUIPO_A_ID" NUMBER, 
	...
	"NOMBRE" VARCHAR2(255), 
	"GRUPO_RED" VARCHAR2(1000), 
	 PRIMARY KEY ("ID")
  USING INDEX  ENABLE
   ) ;

  ALTER TABLE "SGT_ENLACES_LOGICOS" ADD CONSTRAINT "ENLACES_SITIO_A" FOREIGN KEY ("SITIO_A_ID")
	  REFERENCES "SGT_SITIOS" ("ID") ENABLE;
  ALTER TABLE "SGT_ENLACES_LOGICOS" ADD CONSTRAINT "EQUIPO_A" FOREIGN KEY ("EQUIPO_A_ID")
	  REFERENCES "SGT_EQUIPOS" ("ID") ENABLE;
  ALTER TABLE "SGT_ENLACES_LOGICOS" ADD CONSTRAINT "INTERFAZ_A" FOREIGN KEY ("INTERFAZ_A_ID")
	  REFERENCES "SGT_INTERFACES" ("ID") ENABLE;
  ALTER TABLE "SGT_ENLACES_LOGICOS" ADD CONSTRAINT "ENLACES_LOGICOS_SITIO_ID_FK" FOREIGN KEY ("SITIO_B_ID")
	  REFERENCES "SGT_SITIOS" ("ID") ENABLE;
  ALTER TABLE "SGT_ENLACES_LOGICOS" ADD CONSTRAINT "ENLACES_LOGICOS_EQUIPO_B_ID_FK" FOREIGN KEY ("EQUIPO_B_ID")
	  REFERENCES "SGT_EQUIPOS" ("ID") ENABLE;
  ALTER TABLE "SGT_ENLACES_LOGICOS" ADD CONSTRAINT "ENLACES_LOGICOS_INTERFAZ_B_ID_FK" FOREIGN KEY ("INTERFAZ_B_ID")
	  REFERENCES "SGT_INTERFACES" ("ID") ENABLE;
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_AUDIT_SGT_ENLACES_LOGICOS" 
    AFTER INSERT OR UPDATE OR DELETE ON SGT_ENLACES_LOGICOS  
    FOR EACH ROW  
DECLARE  
    v_audit_id NUMBER;  
    v_pk_value VARCHAR2(100);  
...
BEGIN  
    ...
    v_audit_id := AUDIT_PKG.START_AUDIT(  
        p_table_name => 'SGT_ENLACES_LOGICOS',  
        p_action => v_action_type  
    );  
    ...
    IF INSERTING THEN  
        ...
        IF :NEW.SITIO_A_ID IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'SITIO_A_ID', NULL, TO_CHAR(:NEW.SITIO_A_ID));  
        END IF;  
          
        IF :NEW.EQUIPO_A_ID IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'EQUIPO_A_ID', NULL, TO_CHAR(:NEW.EQUIPO_A_ID));  
        END IF;  
          
        IF :NEW.INTERFAZ_A_ID IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'INTERFAZ_A_ID', NULL, TO_CHAR(:NEW.INTERFAZ_A_ID));  
        END IF;  
          
        IF :NEW.SITIO_B_ID IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'SITIO_B_ID', NULL, TO_CHAR(:NEW.SITIO_B_ID));  
        END IF;  
          
        IF :NEW.EQUIPO_B_ID IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'EQUIPO_B_ID', NULL, TO_CHAR(:NEW.EQUIPO_B_ID));  
        END IF;  
          
        IF :NEW.INTERFAZ_B_ID IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'INTERFAZ_B_ID', NULL, TO_CHAR(:NEW.INTERFAZ_B_ID));  
        END IF;  
          
        IF :NEW.NOMBRE IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'NOMBRE', NULL, :NEW.NOMBRE);  
        END IF;  
          
        IF :NEW.GRUPO_RED IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'GRUPO_RED', NULL, :NEW.GRUPO_RED);  
        END IF;  
  
    ELSIF UPDATING THEN  
  
        IF NVL(:OLD.SITIO_A_ID, -1) != NVL(:NEW.SITIO_A_ID, -1) THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'SITIO_A_ID', TO_CHAR(:OLD.SITIO_A_ID), TO_CHAR(:NEW.SITIO_A_ID));  
        END IF;  
          
        IF NVL(:OLD.EQUIPO_A_ID, -1) != NVL(:NEW.EQUIPO_A_ID, -1) THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'EQUIPO_A_ID', TO_CHAR(:OLD.EQUIPO_A_ID), TO_CHAR(:NEW.EQUIPO_A_ID));  
        END IF;  
          
        IF NVL(:OLD.INTERFAZ_A_ID, -1) != NVL(:NEW.INTERFAZ_A_ID, -1) THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'INTERFAZ_A_ID', TO_CHAR(:OLD.INTERFAZ_A_ID), TO_CHAR(:NEW.INTERFAZ_A_ID));  
        END IF;  
          
        IF NVL(:OLD.SITIO_B_ID, -1) != NVL(:NEW.SITIO_B_ID, -1) THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'SITIO_B_ID', TO_CHAR(:OLD.SITIO_B_ID), TO_CHAR(:NEW.SITIO_B_ID));  
        END IF;  
          
        IF NVL(:OLD.EQUIPO_B_ID, -1) != NVL(:NEW.EQUIPO_B_ID, -1) THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'EQUIPO_B_ID', TO_CHAR(:OLD.EQUIPO_B_ID), TO_CHAR(:NEW.EQUIPO_B_ID));  
        END IF;  
          
        IF NVL(:OLD.INTERFAZ_B_ID, -1) != NVL(:NEW.INTERFAZ_B_ID, -1) THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'INTERFAZ_B_ID', TO_CHAR(:OLD.INTERFAZ_B_ID), TO_CHAR(:NEW.INTERFAZ_B_ID));  
        END IF;  
          
        IF NVL(:OLD.NOMBRE, 'NULL') != NVL(:NEW.NOMBRE, 'NULL') THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'NOMBRE', :OLD.NOMBRE, :NEW.NOMBRE);  
        END IF;  
          
        IF NVL(:OLD.GRUPO_RED, 'NULL') != NVL(:NEW.GRUPO_RED, 'NULL') THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'GRUPO_RED', :OLD.GRUPO_RED, :NEW.GRUPO_RED);  
        END IF;  
  
    ELSIF DELETING THEN  
  
        IF :OLD.SITIO_A_ID IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'SITIO_A_ID', TO_CHAR(:OLD.SITIO_A_ID), NULL);  
        END IF;  
          
        IF :OLD.EQUIPO_A_ID IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'EQUIPO_A_ID', TO_CHAR(:OLD.EQUIPO_A_ID), NULL);  
        END IF;  
          
        IF :OLD.INTERFAZ_A_ID IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'INTERFAZ_A_ID', TO_CHAR(:OLD.INTERFAZ_A_ID), NULL);  
        END IF;  
          
        IF :OLD.SITIO_B_ID IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'SITIO_B_ID', TO_CHAR(:OLD.SITIO_B_ID), NULL);  
        END IF;  
          
        IF :OLD.EQUIPO_B_ID IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'EQUIPO_B_ID', TO_CHAR(:OLD.EQUIPO_B_ID), NULL);  
        END IF;  
          
        IF :OLD.INTERFAZ_B_ID IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'INTERFAZ_B_ID', TO_CHAR(:OLD.INTERFAZ_B_ID), NULL);  
        END IF;  
          
        IF :OLD.NOMBRE IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'NOMBRE', :OLD.NOMBRE, NULL);  
        END IF;  
          
        IF :OLD.GRUPO_RED IS NOT NULL THEN  
            AUDIT_PKG.LOG_CHANGES(v_audit_id, 'SGT_ENLACES_LOGICOS', 'ID', v_pk_value, 'GRUPO_RED', :OLD.GRUPO_RED, NULL);  
        END IF;  
    END IF;  
...
EXCEPTION  
    WHEN OTHERS THEN  
        ...
        NULL;  
END TRG_AUDIT_SGT_ENLACES_LOGICOS;

/
ALTER TRIGGER "TRG_AUDIT_SGT_ENLACES_LOGICOS" ENABLE;
...
ALTER TRIGGER "TRG_AUDIT_SGT_ENLACES_TRAMOS" ENABLE;
  ...
  CREATE TABLE "SGT_ENLACES_WAN" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 490 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
...
ALTER TRIGGER "TRG_AUDIT_SGT_ENLACE_LOGICO_TRAMO" ENABLE;
  ...
  CREATE TABLE "SGT_EQUIPOS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 2817 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	...
	"ACTUALIZADO_EL" TIMESTAMP (6), 
	 PRIMARY KEY ("ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "CHK_ESTADOS_VALUES" CHECK (estado IN ('Apagado', 'Utilizado', 'No utilizado', 'S/D', 'Desconocido', 'Retirado', 'Planificado', 'Baja' )) ENABLE, 
...
ALTER TRIGGER "TRG_AUDIT_SGT_EQUIPOS" ENABLE;
  ...
  CREATE TABLE "SGT_INTERFACES" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 26606 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"EQUIPO_ID" NUMBER, 
...
ALTER TRIGGER "TRG_ST_SGT_IP_ADM" ENABLE;
  ...
  CREATE TABLE "SGT_RACKS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 645 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
...
ALTER TRIGGER "TRG_AUDIT_SGT_RACKS" ENABLE;
  ...
  CREATE TABLE "SGT_SALAS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 240 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
...
ALTER TRIGGER "TRG_AUDIT_SGT_SALAS" ENABLE;
  ...
  CREATE TABLE "SGT_SERVICIOS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 390 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"NOMBRE" VARCHAR2(255), 
...
ALTER TRIGGER "SERVICIOS_ST_TRG" ENABLE;
   ...
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 230 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
...
ALTER TRIGGER "TRG_AUDIT_SGT_SITIOS" ENABLE;
  ...
  CREATE TABLE "SGT_SITIOS_ENLACE_WAN" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 243 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"SITIO_ID" NUMBER, 
...
ALTER TRIGGER "TRG_AUDIT_SGT_TIPO_EQUIPOS" ENABLE;
  ...
  CREATE TABLE "SGT_TIPO_INTERFAZ" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 24 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
